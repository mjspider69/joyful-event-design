        ...
        <div className="flex items-center justify-center min-h-screen px-4 pt-16">
          <Card className="w-full max-w-md bg-maroon-800/95 border-gold-600 shadow-2xl shadow-gold-400/20 animate-scale-in">
            <CardContent className="p-8 text-center">
              <Heart className="h-16 w-16 text-gold-400 mx-auto mb-6 animate-float" />
              <h2 className="text-2xl font-cinzel metallic-gold mb-4">Welcome Back!</h2>
              <p className="metallic-gold-subtle font-cormorant mb-6">
                You have successfully logged into your customer account.
              </p>
              <Button 
                onClick={() => {
                  setIsLoggedIn(false);
        ...
        <Card className="w-full max-w-md bg-maroon-800/95 border-gold-600 shadow-2xl shadow-gold-400/20 animate-scale-in">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-cinzel metallic-gold">
              {showOTP ? 'Verify Your Email' : (isLogin ? 'Customer Login' : 'Create Account')}
            </CardTitle>
          </CardHeader>
          <CardContent>
            {showOTP ? (
              ...
              <>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    {isLogin ? 'Send OTP & Login' : 'Create Account & Verify'}
                  </Button>
                </form>
