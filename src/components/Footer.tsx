        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              India's most trusted event planning platform. Making your dream events a reality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link to="/services" className="hover:text-pink-400 transition-colors">Event Photography</Link></li>
              <li><Link to="/services" className="hover:text-pink-400 transition-colors">Event Venues</Link></li>
              <li><Link to="/services" className="hover:text-pink-400 transition-colors">Event Planners</Link></li>
              <li><Link to="/services" className="hover:text-pink-400 transition-colors">Catering Services</Link></li>
              <li><Link to="/services" className="hover:text-pink-400 transition-colors">Decoration Services</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link to="/gallery" className="hover:text-pink-400 transition-colors">Event Gallery</Link></li>
              <li><Link to="/blog" className="hover:text-pink-400 transition-colors">Event Blog</Link></li>
